...
moduleFormat = {'Unknown','UDIMM','SODIMM','UniDIMM','RDIMM','LRDIMM','FBDIMM','RIMM','SORIMM','ISA Card','SIMM','SIP','DIP'}
icType = {'Unknown','DDR','DDR2','DDR3','DDR3L','DDR3U','DDR3L/DDR4','DDR4','DDR5','SDRAM','DRAM','EDO DRAM','FPRAM'} # This will determine base voltage
errorCorrection = {'Unknown','none/non-ECC','ECC','Parity','CRC', 'on-die ECC'}
registerBufferMfg = {'Unknown','N/A','Inphi','IDT','Intel','Rambus','Montage Technology'}
...
allSpeedsDropdown.grid(row=5, column=0, sticky='nesw', padx=5, pady=2.5)
allSpeedsVar.set("Speed")
errorCorrectionDropdown = tk.OptionMenu(root, errorCorrectionVar, *errorCorrection)
errorCorrectionDropdown.grid(row=6, column=0, sticky='nesw', padx=5, pady=2.5)
...
generateButton.grid(row=12, sticky='nesw', padx=5, pady=2.5)
output = Text(root)
output.grid(row=13, sticky='nesw', padx=5, pady=2.5)

...
errorCorrectionDropdown.grid(row=5, column=0, sticky='nesw', padx=5, pady=2.5)
...
generateButton.grid(row=11, sticky='nesw', padx=5, pady=2.5)
output = Text(root)
output.grid(row=12, sticky='nesw', padx=5, pady=2.5)
